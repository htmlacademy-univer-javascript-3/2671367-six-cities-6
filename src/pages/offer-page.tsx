...
import {
  useNearOffers,
  useOffer,
} from '../entities/offer/usecases/offer-usecases';
import { CityMap } from '../app/widgets/city-map/city-map';

import { HeaderContainer } from '../app/widgets/header/header-container';
import { OfferDetailsUI } from '../entities/offer/components/offer-details/offer-details';
...
import { useReviewsByOffer } from '../entities/review/usecases/review-usecases';
